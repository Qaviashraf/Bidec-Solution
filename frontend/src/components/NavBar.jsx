            ...
            <div className='flex justify-between items-center max-w-screen min-w-screen px-10 py-4 bg-white bg-trasparent bg-opacity-0 backdrop-filter backdrop-blur-lg '>
                ...
                <ul className='hidden md:flex font-semibold gap-8 '>
                    ...
                    <div className='relative'>
                        <NavLink to='/service/branding' className={({ isActive }) => `flex font-sans ${isActive ? 'text-[#227c85] font-bold' : 'text-black'} hover:text-[#227c85] text-lg duration-300 cursor-pointer`} onClick={handleToggleServices}>SERVICES
                            {showServices ? (
                    ...
                    <NavLink to='/about' className={({ isActive }) => `font-sans ${isActive ? 'text-[#227c85] font-bold' : 'text-black'} hover:text-[#227c85] text-lg duration-300 cursor-pointer`}>ABOUT US</NavLink>
