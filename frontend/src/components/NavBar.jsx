            ...
            <div className='flex justify-between items-center max-w-screen min-w-screen px-10 py-4 bg-white bg-trasparent bg-opacity-0 backdrop-filter backdrop-blur-lg '>
                ...
                <ul className='hidden md:flex font-semibold gap-8 '>
                    ...
                    <div className='relative'>
                        ...
                        {showServices && (
                            <div className='absolute z-10 left-0 top-full flex flex-col mt-2 w-48 bg-white border border-gray-300 shadow-lg rounded-2xl'>
                                <Link to='./service/web-design-development' className='font-sans px-4 py-2 hover:bg-gray-100'>Web Development</Link>
                                <Link to='./service/web-design-development' className='font-sans px-4 py-2 hover:bg-gray-100'>Graphic Designing</Link>
                                <Link to='./service/branding' className='font-sans px-4 py-2 hover:bg-gray-100'>Digital Marketing</Link>
                            </div>
                        )}
                    </div>
