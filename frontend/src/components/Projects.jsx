...
function Projects() {
    return (
        <div className="pb-10 px-3 py-5">
            ...
            <div
                className="heading flex justify-center text-center md:text-evenly lg:justify-around items-center flex-col md:flex-row gap-20 md:my-10 md:px-20">
                <span
                    data-aos="fade-right"
                    className="lg:text-6xl text-4xl lg:w-[60%] w-full relative">
                    Our
                ...
                <div
                    data-aos="fade-down" className="relative hidden lg:block">
                    ...
                    <ul className='absolute bottom-[-10vh] right-[12vh] pl-20 hover:bg-gray-300'>
                        ...
                        <Link to='service/web-design-development' className='font-sans bottom-[8vw] rotate-[330deg] left-[-8vw] absolute text-lg rounded-full bg-[#227C851A] border-2 border-[#FFFFFF] px-5 py-2  w-48 text-center hover:bg-[#227C85] hover:text-white hover:border-[#227C85]'>development</Link>
                        ...
                        <Link to='service/web-design-development' className='font-sans bottom-0 rotate-0 left-4 absolute text-lg rounded-full bg-[#227C851A] border-2 border-[#FFFFFF] px-5 py-2  w-48 text-center hover:bg-[#227C85] hover:text-white hover:border-[#227C85]'>Web design</Link>
                    </ul>
                </div>
