...
export const Blogs = () => {
    ...
    return (
        <div className='py-32 justify-center max-w-screen'>
            <div className='flex flex-wrap justify-around items-center my-10 px-4'>
                <h1
                    data-aos="fade-right"
                    className='text-3xl md:text-5xl my-2 text-center'>Latest articles</h1>
                        ...
                        {products.map((product) => (
                            <a key={product.id} href={product.href} className="group">
                                <div className='w-full'>
                                    <img src={product.imageSrc} alt={product.imageAlt} className='w-full group-hover:opacity-75' />
